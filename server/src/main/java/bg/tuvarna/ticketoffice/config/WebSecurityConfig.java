    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.csrf().disable()
            .authorizeRequests()
                ...
                .antMatchers("/user/profile", "/user/details/*").hasAnyAuthority(Role.ORGANISER.name(), Role.DISTRIBUTOR.name())
                .antMatchers("/event/create", "/event/edit", "/event/details/*", "/user/rate").hasAnyAuthority(Role.ORGANISER.name())
